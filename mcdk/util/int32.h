...
public:
    ...
    MC_CAST(ToInt16, uint32_t, int16_t, INT16_MIN, INT16_MAX)
    ...
    MC_CAST(ToInt32, uint32_t, int32_t, INT32_MIN, INT32_MAX)
    MC_CAST(FromInt32, int32_t, uint32_t, 0, UINT32_MAX)
    MC_CAST(ToInt64, uint32_t, int64_t, INT64_MIN, INT64_MAX)
    MC_CAST(FromInt64, int64_t, uint32_t, 0, UINT32_MAX)
    MC_CAST(ToUInt64, uint32_t, uint64_t, 0, UINT64_MAX)
    MC_CAST(FromUInt64, uint64_t, uint32_t, 0, UINT32_MAX)
